...
public class SyncMain {
    ...
    private void getStartedDemo() throws Exception {
        ...
        defaultPolicy.setPreferredLocations(Lists.newArrayList("Central India"));
        ...
        //AccountEndpoint=https://cosmossqldatabase.documents.azure.com:443/;
        //AccountKey=ZkQI4hqWWUmvdUYDEXpg5SxTKYqsdVcjUXpzrHQtlbf2WoGim3dAtuG2WrLa5aEILHAybpTasF6niy2saTpWDw==;
        System.out.println("======== Connected with HOST and MASTER_KEY ========");
        //  </CreateSyncClient>
        ...
        System.out.println("Adding families to create");
